...
export class GeminiClient {
  ...
  ${folderStructure}
    ...
    // DISABLED: Full file context preprocessing - causes filename corruption and content filtering
    // This preprocessing layer corrupts filenames, strips data, and prevents Gemma from seeing
    // raw file content directly. Let Gemma request files through tools when actually needed.
    // 
