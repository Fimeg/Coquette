...
// Temporarily disabled telemetry imports to fix system
// import {
//   initializeTelemetry,
...
const DEFAULT_TELEMETRY_TARGET = 'local';
...
export class Config {
  ...
  constructor(params: ConfigParameters) {
    ...
    if (this.telemetrySettings.enabled) {
      // Temporarily disabled telemetry to fix system startup
    ...
    if (this.getUsageStatisticsEnabled()) {
      ...
      // );
      console.log('Telemetry temporarily disabled');
    } else {
